...
import { PDA1SupportedCredentialSdJwt } from "./SupportedCredentialsConfiguration/PDA1SupportedCredentialSdJwt";
...
export class CredentialIssuersConfigurationService implements CredentialIssuersConfiguration {
	...
	public registeredCredentialIssuerRepository(): CredentialIssuersRepository {
		...
		ehicIssuer.addSupportedCredential(new PDA1SupportedCredentialSdJwt(ehicIssuer));
